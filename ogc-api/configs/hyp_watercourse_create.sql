...
CREATE TABLE public.hyp_hydroid (
	id serial NOT NULL,
	hyp_object varchar(100) NULL,
...
(id, gmlid, metadata, localid, "namespace", "version", beginlsv, endlsv, genwcurl, geoname, related, 
...
VALUES('id', 'gmlid', 'metadata', 'localid', 'namespace', 'version', '2017-11-10 00:00:00', '2019-11-10 00:00:00', 'http://service.datacove.eu/geoserver/ogc/features/collections/hy-n:HydroNode/items/_', 'geoname', 'related', 
...
INSERT INTO public.hyp_hydroid
(hyp_object, hydroid, hydroidclass, hydroidns)
VALUES('id', 'hydroid', 'hydroidclass', 'hydroidns');
